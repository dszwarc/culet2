...
urlpatterns = [
    ...
    path("jobs/batch/start/", views.BatchStartView.as_view(), name="batch_start"),
    path("jobs/batch/<int:pk>/stop/", views.StopWorkBatchView.as_view(), name="stop_work_batch"),
    ...
    path(
        "change-status/",
        views.ChangeJobStatusView.as_view(),
        name="change_status",
    ),
    ...
    path("reports/payroll/excel/", views.PayrollExcelView.as_view(), name="payroll_excel"),
